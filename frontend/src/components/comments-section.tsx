...
import type { CommentWithUser } from "../types/api";
...
const CommentSection = ({ productId, comments = [], currentUserId }: Props) => {
      ...
      {isSignedIn ? (
        ...
        <div className="flex items-center justify-between bg-base-200 rounded-lg p-3">
          ...
          <SignInButton mode="modal">
            <button className="btn btn-primary btn-sm gap-1">Sign In</button>
          </SignInButton>
        </div>
      )}
